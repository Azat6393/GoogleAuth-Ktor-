...
import com.berdimyradov.googleauthapp.component.GoogleButton
import com.berdimyradov.googleauthapp.component.MessageBar
...
fun CentralContent(
    ...
    Image(
        modifier = Modifier
            ...
            .size(120.dp),
        painter = painterResource(id = com.berdimyradov.googleauthapp.R.drawable.ic_google_logo),
    ...
    GoogleButton(loadingState = signedInState, onClick = onButtonClicked)
}
